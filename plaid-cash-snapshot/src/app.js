...
//  console.log('plaidRoutes:', typeof plaidRoutes);
//  console.log('balanceRoutes:', typeof balanceRoutes);
//  console.log('recurringRoutes:', typeof recurringRoutes);
 ...
 //console.log('About to use authRoutes');
 app.use(`${apiPrefix}/auth`, authRoutes);
 
 //console.log('About to use plaidRoutes');
 app.use(`${apiPrefix}`, plaidRoutes);
 
 //console.log('About to use balanceRoutes');
 app.use(`${apiPrefix}`, balanceRoutes);
 
 //console.log('About to use recurringRoutes');
...
//  console.log('About to use errorHandler');
